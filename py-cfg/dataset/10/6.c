...
int main()
{
    int attempt, numb_words,i ,j , k, l, z, count = 0, m, n = 0, t = 0, q = 0, a, b, d,I,J,K,L,Z,A,B,C,D,N;
    attempt = inp();
    while(attempt)
    {
        numb_words = inp();
                                    ...
                                    for(l = 0; l < 8; l++)
                                    {
                                        ...
                                        if(numb_words == 4)
                                        {
                                            t = 0;
                                                         ...
                                                         for(n = 0,N = 3; n < 4 ; n++,N--)
                                                         {
                                                             valid[t][0][N] = matrix[n][0];
                                                             valid[t][1][N] = matrix[n][1];
                                                             valid[t][2][N] = matrix[n][2];
                                                             valid[t][3][N] = matrix[n][3];
                                                         }
                                                         t++;
                                                         for(n = 0; n < 4; n++)
                                                         {
                                                        ...
                                                        q++;
                                                         if(q == 1)
                                                         {
                                                             answer[0][0] = valid[0][0][0];
                                                             answer[0][1] = valid[0][0][1];
                                                             answer[0][2] = valid[0][0][2];
                                                             answer[0][3] = valid[0][0][3];
                                                             answer[1][0] = valid[0][1][0];
                                                             answer[1][1] = valid[0][1][1];
                                                             answer[1][2] = valid[0][1][2];
                                                             answer[1][3] = valid[0][1][3];
                                                             answer[2][0] = valid[0][2][0];
                                                             answer[2][1] = valid[0][2][1];
                                                             answer[2][2] = valid[0][2][2];
                                                             answer[2][3] = valid[0][2][3];
                                                             answer[3][0] = valid[0][3][0];
                                                             answer[3][1] = valid[0][3][1];
                                                             answer[3][2] = valid[0][3][2];
                                                             answer[3][3] = valid[0][3][3];
